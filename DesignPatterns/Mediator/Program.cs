...
namespace csharp.training.congruent.apps.patterns
{
    ...
    class ConcreteMediator : IMediator
    {
        ...
        {
            return "I am a mediator and mediate co-ordination between " + _component1.GetType().Name + " and " + _component2.GetType().Name;
    ...
    class Program
    {
        static void Main(string[] _)
        {
            ...
            Console.WriteLine(concreteMediator.ToString());
