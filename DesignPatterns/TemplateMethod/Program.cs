...
namespace csharp.training.congruent.apps.patterns
{
    ...
    abstract class AbstractClass
    {
        ...
        protected string _name = "AbstractClass or RealClass";
        ...
        {
            Console.WriteLine($"AbstractClass says: I {_name} am doing the bulk of the work");
        }

        protected void BaseOperation2()
        {
            Console.WriteLine($"AbstractClass says: But I {_name} let subclasses override some operations");
        }

        protected void BaseOperation3()
        {
            Console.WriteLine($"AbstractClass says: But I {_name} am doing the bulk of the work anyway");
        }
