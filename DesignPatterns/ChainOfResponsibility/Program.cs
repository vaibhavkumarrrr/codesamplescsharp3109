...
namespace csharp.training.congruent.apps.patterns
{
    ...
    class MonkeyHandler : AbstractHandler
    {
        ...
        {
            if ((request as string) == "Banana" || (request as string) == "Cup of coffee")
            {
    ...
    class Client
    {
        ...
        {
            foreach (var food in new List<string> { "Nut", "MeatBall", "Nut","Banana", "Cup of coffee" })
            {
    ...
    class Program
    {
        static void Main(string[] _)
        {
            ...
            monkey.SetNext(squirrel).SetNext(dog);
            //squirrel.SetNext(dog).SetNext(monkey);
